...
books = []
with open("/VV/QAPython/Homework/HW3/files/books.csv", "r") as f:
    reader = DictReader(f)
    for row in reader:
        book = {}
...
users = []
with open("/VV/QAPython/Homework/HW3/files/users.json", "r") as f:
    users_load = load(f)
...
for row in users_load:
    ...
    i = j
    users.append(user)
with open("/VV/QAPython/Homework/HW3/files/result.json", "w") as f:
